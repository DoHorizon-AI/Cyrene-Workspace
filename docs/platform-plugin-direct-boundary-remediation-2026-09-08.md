...
| `CON-001` | .NET format/build and 16 direct Plugin tests passed at `d3ef2b72...`; at final AstrBot `424cfd2c51d9c848c86c597ce4e44d3efc813bf6`, the two model bridge tests pass with every Plugins path unset, and Workspace's exact Platform `c4478232...` / Plugins `a019cc37...` / AstrBot `424cfd2c...` OneBot lifecycle TCK passes `1/1` with zero skipped; 57 broader tests on superseded candidate `f3d9b42c...` are historical evidence only | AstrBot build `#504` is running at exact `424cfd2c...`; `#500` exposed the now-fixed test-fixture coupling | AstrBot PR `#14` open | `CANDIDATE` |
...
| `ACC-002` | Workspace thin orchestrator passed the AstrBot-owned direct OneBot lifecycle TCK at Platform `c44782320db933a5328c8ccf32c4c830563b2cf6`, Plugins `a019cc37cab39ffafe30884a4a0427aaaadf69a9` and AstrBot `424cfd2c51d9c848c86c597ce4e44d3efc813bf6`; one real lifecycle test passed with zero skipped, and retired CES driver and duplicate peers/package host remain absent | Workspace build `#498` proved the preceding pinned vertical; final repinned successor run required | pending | `IN_PROGRESS` |

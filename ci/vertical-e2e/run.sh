...
CYRENE_PLATFORM_REF="${CYRENE_PLATFORM_REF:-c44782320db933a5328c8ccf32c4c830563b2cf6}"
CYRENE_PLUGINS_REF="${CYRENE_PLUGINS_REF:-a019cc37cab39ffafe30884a4a0427aaaadf69a9}"
CYRENE_ASTRBOT_REF="${CYRENE_ASTRBOT_REF:-b3dfb46312f132dce714dc459fec022cdf4f0121}"

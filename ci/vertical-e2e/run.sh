...
CYRENE_PLATFORM_REF="${CYRENE_PLATFORM_REF:-64636dea7a205e13d7ee2073d4a0fb3568b0f80f}"
CYRENE_PLUGINS_REF="${CYRENE_PLUGINS_REF:-a019cc37cab39ffafe30884a4a0427aaaadf69a9}"
CYRENE_ASTRBOT_REF="${CYRENE_ASTRBOT_REF:-f3d9b42c1218365c88c6cf065f22b1312f0c605b}"

...
CYRENE_PLATFORM_REF="${CYRENE_PLATFORM_REF:-9305517dbe137bf343aa6eee334c2b352807bed6}"
CYRENE_PLUGINS_REF="${CYRENE_PLUGINS_REF:-a019cc37cab39ffafe30884a4a0427aaaadf69a9}"
CYRENE_ASTRBOT_REF="${CYRENE_ASTRBOT_REF:-6ce3746d9d4e3f7d57d96e2e2ce3cfa91e8e3bf0}"
